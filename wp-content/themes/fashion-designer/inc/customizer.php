...
function fashion_designer_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('fashion_designer_email',array(
		'default'=> '',
		'sanitize_callback'	=> 'fashion_designer_sanitize_email'
	));
	...
	$wp_customize->add_setting( 'fashion_designer_metabox_hide_show',array(
      'default' => 1,
      'transport' => 'refresh',
      'sanitize_callback' => 'fashion_designer_switch_sanitization'
    ));  
    $wp_customize->add_control( new Fashion_Designer_Toggle_Switch_Custom_Control( $wp_customize, 'fashion_designer_metabox_hide_show',array(
      'label' => esc_html__( 'Show / Hide Metabox','fashion-designer' ),
      'section' => 'fashion_designer_responsive_media'
    )));
