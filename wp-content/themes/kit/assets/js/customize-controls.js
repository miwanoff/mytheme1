/* global kitBgColors, kitColor, jQuery, wp, _ */
/**
...
(function () {
    ...
    wp.customize("accent_hue", function (value) {
      value.bind(function (to) {
        ...
        Object.keys(kitBgColors).forEach(function (context) {
          ...
          if (kitBgColors[context].color) {
            backgroundColorValue = kitBgColors[context].color;
          } else {
            backgroundColorValue = wp
              .customize(kitBgColors[context].setting)
              .get();
          }
          kitSetAccessibleColorsValue(context, backgroundColorValue, to);
        });
      });
    });
   ...
   * @return {void}
   */
  function kitSetAccessibleColorsValue(context, backgroundColor, accentHue) {
    var value, colors;
    ...
    colors = kitColor(backgroundColor, accentHue);
   ...
   * @return {void}
   */
  function kitSetRetineLogoVisibility(visible) {
