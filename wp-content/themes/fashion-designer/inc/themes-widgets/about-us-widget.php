...
class Fashion_Designer_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Fashion_Designer_About_Widget',
			__('VW About us', 'fashion-designer'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'fashion-designer' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','fashion-designer'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','fashion-designer'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','fashion-designer'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','fashion-designer'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','fashion-designer'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','fashion-designer'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function fashion_designer_about_custom_load_widget() {
	register_widget( 'Fashion_Designer_About_Widget' );
}
add_action( 'widgets_init', 'fashion_designer_about_custom_load_widget' );