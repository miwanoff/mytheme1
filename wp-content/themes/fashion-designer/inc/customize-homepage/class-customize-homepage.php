...
if ( ! class_exists( 'Fashion_Designer_Content_Creation' ) ) :

	/**
	 * Fashion_Designer_Content_Creation class.
	 */
	class Fashion_Designer_Content_Creation extends WP_Customize_Control {
		 ...
		 */
		public $type = 'fashion-designer-content-creation';
		...
		/**
		 * Fashion_Designer_Content_Creation constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'Fashion_Designer_Content_Creation' );
