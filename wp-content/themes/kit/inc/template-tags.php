 ...
 */
function kit_site_logo($args = array(), $echo = true)
{
 ...
 */
function kit_site_description($echo = true)
{
            ...
            ?>
					<li class="post-author meta-wrapper">
						<span class="meta-icon">
							<span class="screen-reader-text"><?php _e('Post author', 'kit');?></span>
        ...
        if (in_array('post-date', $post_meta, true)) {
            ...
            ?>
					<li class="post-date meta-wrapper">
						<span class="meta-icon">
							<span class="screen-reader-text"><?php _e('Post date', 'kit');?></span>
        ...
        if (in_array('categories', $post_meta, true) && has_category()) {
            ...
            ?>
					<li class="post-categories meta-wrapper">
						<span class="meta-icon">
							<span class="screen-reader-text"><?php _e('Categories', 'kit');?></span>
        ...
        if (in_array('tags', $post_meta, true) && has_tag()) {
            ...
            ?>
					<li class="post-tags meta-wrapper">
						<span class="meta-icon">
							<span class="screen-reader-text"><?php _e('Tags', 'kit');?></span>
...
function kit_add_sub_toggles_to_main_menu($args, $item, $depth)
{
    ...
    if (isset($args->show_toggles) && $args->show_toggles) {
        ...
        if (in_array('menu-item-has-children', $item->classes, true)) {
            ...
            $args->after .= '<button class="toggle sub-menu-toggle fill-children-current-color" data-toggle-target="' . $toggle_target_string . '" data-toggle-type="slidetoggle" data-toggle-duration="' . absint($toggle_duration) . '" aria-expanded="false"><span class="screen-reader-text">' . __('Show sub menu', 'kit') . '</span>' . kit_get_theme_svg('chevron-down') . '</button>';
