...
<div id="help-panel" class="panel-left">
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://docs.blossomthemes.com/docs/blossom-spa/' ); ?>" title="<?php esc_attr_e( 'Visit the Documentation', 'blossom-spa' ); ?>" target="_blank"><?php esc_html_e( 'View Documentation', 'blossom-spa' ); ?></a>
    </div><!-- .panel-aside -->
    
    <div class="panel-aside">
        <h4><?php esc_html_e( 'Support Ticket', 'blossom-spa' ); ?></h4>
        <p><?php printf( __( 'It\'s always a good idea to visit our %1$sKnowledge Base%2$s before you send us a support ticket.', 'blossom-spa' ), '<a href="'. esc_url( 'https://docs.blossomthemes.com/docs/blossom-spa/' ) .'" target="_blank">', '</a>' ); ?></p>
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://blossomthemes.com/theme-demo/?theme=blossom-spa' ); ?>" title="<?php esc_attr_e( 'Visit the Demo', 'blossom-spa' ); ?>" target="_blank"><?php esc_html_e( 'View Demo', 'blossom-spa' ); ?></a>
    </div><!-- .panel-aside -->
</div>
