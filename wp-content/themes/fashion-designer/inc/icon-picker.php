...
class Fashion_Designer_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'fashion-designer' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $fashion_designer_font_awesome_icon_array = fashion_designer_font_awesome_icon_array();
                    foreach ($fashion_designer_font_awesome_icon_array as $fashion_designer_font_awesome_icon) {
                            $icon_class = $this->value() == $fashion_designer_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($fashion_designer_font_awesome_icon).'"></i>
                            <span class="fashion-designer-social-class">'.esc_attr($fashion_designer_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function fashion_designer_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', get_template_directory_uri().'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'fashion-designer-customizer-script', get_template_directory_uri().'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'fashion_designer_customizer_script' );

if(!function_exists('fashion_designer_font_awesome_icon_array')){
    function fashion_designer_font_awesome_icon_array(){
